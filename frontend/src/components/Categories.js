  ...
  return (
    <div className="dropdown categories">
        ...
        <ul className="dropdown-menu">
            <li onClick={()=>onSelectCategory("")}><button type="button" className="dropdown-item text-start">All Categories</button></li>
            ...
            {!loading && categories.length > 0 && (
                categories.map((cat) => (
                    <li key={cat._id} onClick={()=>onSelectCategory(cat._id)}>
